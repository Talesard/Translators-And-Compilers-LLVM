...
for.body:                                         ; preds = %for.cond
  ...
  store i64 0, i64* %arrayidx6, align 16
  ...
  store i64 0, i64* %arrayidx10, align 16
  ...
  store i64 0, i64* %arrayidx14, align 16
  ...
  store i64 0, i64* %arrayidx18, align 16
...
if.then:                                          ; preds = %for.body49
  ...
  call void @__cxa_throw(i8* %exception, i8* bitcast (i8** @_ZTIPKc to i8*), i8* null) #8
  unreachable
